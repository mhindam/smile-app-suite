    ...
    <div dir="rtl" className="flex min-h-screen flex-col bg-background text-on-surface">
      ...
      <header className="sticky top-0 z-30 flex items-center justify-between bg-surface px-4 py-3 shadow-card">
        ...
        <div className="flex items-center gap-2">
          <Link
            to="/track"
            className="flex items-center gap-1.5 rounded-2xl bg-secondary-container px-3 py-2 text-sm font-bold text-on-secondary-container"
          >
          ...
          <Link
            to="/order"
            className="flex items-center gap-1.5 rounded-2xl bg-primary px-3 py-2 text-sm font-bold text-primary-foreground"
          >
